...
export const mockProviders: ProviderSearchResult[] = [
  ...
  },
  {
    ...
    free_delivery_min_price: 150,
    free_delivery_max_km: 3,
    is_promoted: false,
    blocked: false,
    created_at: new Date().toISOString(),
    distance_meters: randomDistance(),
  ...
  },
  {
    ...
    min_order_quantity: 1,
    bulk_order_enabled: true,
    free_delivery_min_price: 300,
    free_delivery_max_km: 7,
    is_promoted: true,
    blocked: false,
    created_at: new Date().toISOString(),
    distance_meters: randomDistance(),
  ...
  },
  {
    ...
    min_order_quantity: 1,
    bulk_order_enabled: true,
    free_delivery_min_price: 250,
    free_delivery_max_km: 4,
    is_promoted: false,
    blocked: false,
    created_at: new Date().toISOString(),
    distance_meters: randomDistance(),
  ...
  },
  {
    ...
    min_order_quantity: 1,
    bulk_order_enabled: false,
    free_delivery_min_price: 100,
    free_delivery_max_km: 2,
    is_promoted: false,
    blocked: false,
    created_at: new Date().toISOString(),
    distance_meters: randomDistance(),
